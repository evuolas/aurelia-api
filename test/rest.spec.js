...
describe('Rest', function() {
  describe('.find()', function() {
    xit('Should find results for multiple endpoints.', function(done) {
    ...
    xit('Should find with RFC6570 queries.', function(done) {
      let injectTest = container.get(InjectTest);
  ...
  describe('.findOne()', function() {
    xit('Should find with id, criteria and options.', function(done) {
      let injectTest = container.get(InjectTest);
      injectTest.apiEndpoint.useTraditionalUriTemplates = false;
    ...
    xit('Should findOne with RFC6570 queries.', function(done) {
      let injectTest = container.get(InjectTest);
      injectTest.apiEndpoint.useTraditionalUriTemplates = true;
  ...
  describe('.update()', function() {
    xit('Should update with body (as json).', function(done) {
      let injectTest = container.get(InjectTest);
    ...
    xit('Should update with body (as json), criteria and options.', function(done) {
      let injectTest = container.get(InjectTest);
      injectTest.apiEndpoint.useTraditionalUriTemplates = false;
    ...
    xit('Should update with RFC6570 queries.', function(done) {
      let injectTest = container.get(InjectTest);
      injectTest.apiEndpoint.useTraditionalUriTemplates = true;
  ...
  describe('.updateOne()', function() {
    ...
    xit('Should updateOne with RFC6570 queries.', function(done) {
      let injectTest = container.get(InjectTest);
      injectTest.apiEndpoint.useTraditionalUriTemplates = true;
  ...
  describe('.patch()', function() {
    xit('Should patch with body (as json).', function(done) {
      let injectTest = container.get(InjectTest);
      injectTest.apiEndpoint.useTraditionalUriTemplates = false;
    ...
    xit('Should patch with body (as json), criteria and options.', function(done) {
      let injectTest = container.get(InjectTest);
      injectTest.apiEndpoint.useTraditionalUriTemplates = false;
    ...
    xit('Should patch with RFC6570 queries.', function(done) {
      let injectTest = container.get(InjectTest);
      injectTest.apiEndpoint.useTraditionalUriTemplates = true;
  ...
  describe('.patchOne()', function() {
    xit('Should patch with body (as json), id, criteria and options.', function(done) {
      let injectTest = container.get(InjectTest);
      injectTest.apiEndpoint.useTraditionalUriTemplates = false;
    ...
    xit('Should patchOne with RFC6570 queries.', function(done) {
      let injectTest = container.get(InjectTest);
      injectTest.apiEndpoint.useTraditionalUriTemplates = true;
  ...
  describe('.destroy()', function() {
    xit('Should destroy with criteria and options.', function(done) {
      let injectTest = container.get(InjectTest);
      injectTest.apiEndpoint.useTraditionalUriTemplates = false;
    ...
    xit('Should destroy with RFC6570 queries.', function(done) {
      let injectTest = container.get(InjectTest);
      injectTest.apiEndpoint.useTraditionalUriTemplates = true;
  ...
  describe('.destroyOne()', function() {
    xit('Should destroy with id, criteria and options.', function(done) {
      let injectTest = container.get(InjectTest);
      injectTest.apiEndpoint.useTraditionalUriTemplates = false;
    ...
    xit('Should destroyOne with RFC6570 queries.', function(done) {
      let injectTest = container.get(InjectTest);
      injectTest.apiEndpoint.useTraditionalUriTemplates = true;
  ...
  describe('.create()', function() {
    xit('Should create body (as json).', function(done) {
      let injectTest = container.get(InjectTest);
    ...
    xit('Should create body (as json) and options.', function(done) {
      let injectTest = container.get(InjectTest);
  ...
  describe('.post()', function() {
    xit('Should post body (as urlencoded).', function(done) {
      let injectTest = container.get(InjectTest);
    ...
    xit('Should post body (as FormData) and options.', function(done) {
      let injectTest = container.get(InjectTest);
